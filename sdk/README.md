# PSDataRepository Extensions SDK (0.7.0)

> This package set is versioned with the module build it came from (module `0.7.0`).
...
- `PSDataRepository.Abstractions.0.7.0.nupkg`
- `PSDataRepository.Authentications.0.7.0.nupkg`
- `PSDataRepository.Authentications.AzAuth.0.7.0.nupkg`
- `PSDataRepository.Extensions.Sdk.0.7.0.nupkg`
- `PSDataRepository.Formatters.0.7.0.nupkg`
- `PSDataRepository.Providers.0.7.0.nupkg`
...
3. Reference the SDK from your extension project:
   ...
   ```sh
   dotnet add package PSDataRepository.Extensions.Sdk --version 0.7.0
   ```
